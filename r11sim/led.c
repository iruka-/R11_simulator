...
//	if(led_trace) {
	if(draw) {
		...
		// ======== ACC,EA,PCのLEDを書く.
		led16draw(LED_X+48,LED_Y+40,16 ,8   ,LED_A ,LED_COL,BITs ,"A");
		led16draw(LED_X+48,LED_Y+40+48 ,16,8,LED_B ,LED_COL,BITs ,"B");
		led16draw(LED_X+48,LED_Y+40+96 ,16,8,LED_C ,LED_COL,BITs ,"C");
		led16draw(LED_X+48,LED_Y+40+144,16,8,LED_pc,LED_COL,BITs ,"PC");
